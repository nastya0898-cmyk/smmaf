  ...
  <div className="pt-20">
    ...
    <section className="section-padding bg-background">
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <AnimatedSection>
          <h2 className="font-heading text-3xl md:text-4xl text-foreground mb-4">Membership Fees</h2>
          <div className="red-accent-line mb-6" />
          <p className="font-body text-muted-foreground leading-relaxed mb-6">
            Annual membership fees for SMMAF affiliation.
          </p>
          <div className="grid sm:grid-cols-3 gap-4">
            {[
              { type: "Gym", price: "CHF 250" },
              { type: "Coach", price: "CHF 100" },
              { type: "Fighter", price: "CHF 90" },
            ].map((item) => (
              <div key={item.type} className="border border-border p-6 text-center">
                <p className="font-body text-xs text-muted-foreground uppercase tracking-wider mb-3">{item.type}</p>
                <p className="font-heading text-3xl text-foreground">{item.price}</p>
                <p className="font-body text-xs text-muted-foreground mt-1">per year</p>
              </div>
            ))}
          </div>
        </AnimatedSection>
